...
export default function HeaderDark(props: headerProps) {
    const getStarted = () => {
        if (props.getStarted) {
            return (
    ...
    return (
        <div className="h-[10%] flex w-full bg-[#1e232e] justify-between">
            <Link to="/" className="p-2 flex ml-[20px]">
                ...
                <div className="w-[2px] bg-white h-[75%] my-auto mx-3"></div>
